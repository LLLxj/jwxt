<template>
  <div id="J_common_echarts" class="chart-box"></div>
</template>

<script>
  import { payTotalDay, payTotalWeek, payTotalMonth } from '@/api/regSchoolLog'
  export default {
    props: {
    ...
    methods: {
      ...
      init () {
        ...
        this.echartsLine = echarts.init(document.getElementById('J_common_echarts'), 'walden')
        // 加载数据
        this.initData()
      },
      // 初始化数据
