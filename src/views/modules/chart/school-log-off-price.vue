<template>
  <div id="J_offprice_echarts" class="chart-box"></div>
</template>

<script>
  import { offPriceDay, offPriceWeek, offPriceMonth } from '@/api/regSchoolLog'
  export default {
    props: {
    ...
    methods: {
      ...
      init () {
        ...
        this.echartsLine = echarts.init(document.getElementById('J_offprice_echarts'), 'walden')
        // 加载数据
        this.initData()
      },
      // 初始化数据
