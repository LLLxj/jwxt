<template>
  <div id="J_payment_echarts" class="chart-box"></div>
</template>

<script>
  import { paymentDay, paymentWeek, paymentMonth } from '@/api/regSchoolLog'
  export default {
    props: {
    ...
    methods: {
      ...
      init () {
        ...
        this.echartsLine = echarts.init(document.getElementById('J_payment_echarts'), 'walden')
        // 加载数据
        this.initData()
      },
      // 初始化数据
